...
이 저장소는 **KISA(한국인터넷진흥원) CIIP 2026 가이드라인**에 따른 기술적 취약점 진단 스크립트의 공개 버전입니다.

> **참고**: 이 저장소는 [KISA-CIIP-2026 메인 프로젝트](https://github.com/rebugui/KISA-CIIP-2026-dev)의 **submodule**로 제공됩니다.
