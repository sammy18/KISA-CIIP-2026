...
# [점검 항목 상세]
# @ID          : All
# @Category    : Web Server (웹 서버)
# @Platform    : Microsoft IIS
# @Severity    : 중
# @Title       : 모든 웹서버 점검 스크립트 실행
# @Description : 웹서버 모든 점검 항목을 실행하는 스크립트 (PowerShell 형식)
...
# 진단 항목 목록 (WEB-01~WEB-26)
$DIAGNOSIS_ITEMS = 1..26 | ForEach-Object { "WEB-{0:D2}" -f $_ }
