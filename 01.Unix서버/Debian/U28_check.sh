...
diagnose() {
    ...
    if [ "$hosts_allow_exists" -eq 0 ] && [ "$hosts_deny_exists" -eq 0 ]; then
        ...
        command_result="[FILE NOT FOUND: /etc/hosts.allow /etc/hosts.deny]"
        ...
        command_result="hosts.allow: [empty file], hosts.deny: ${hosts_deny_content:-[FILE NOT FOUND]}"
        ...
        command_result="hosts.allow: ${hosts_allow_content}, hosts.deny: [FILE NOT FOUND]"
