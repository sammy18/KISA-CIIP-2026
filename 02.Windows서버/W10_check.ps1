...
# 2. lib를 통한 결과 저장
$purpose = "Windows 로그인 화면에 마지막 로그온한 사용자 이름이 표시되지 않도록 하여 악의적인 사용자에게 계정정보가노출되는것을차단하고자함"
$threat = "마지막으로 로그온한 사용자의 이름이 로그온 대화상자에 표시될 경우 공격자는 이를 획득하여 비밀번호를추측하거나무작위공격을시도할위험이존재함"
$criteria_good = "'마지막사용자이름표시안함'이'사용'으로설정된경우"
$criteria_bad = "'마지막사용자이름표시안함'이'사용안함'으로설정된경우"
$remediation = "※ WindowsNT:마지막으로로그온한사용자이름표시안함설정 ※ Windows2000:로그온스크린에마지막사용자이름표시안함사용설정 ※ Windows 2003, 2008, 2012, 2016, 2019, 2022:대화형로그온:마지막사용자이름표시안 함사용설정"
