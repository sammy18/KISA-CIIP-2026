...
# 2. lib를 통한 결과 저장
$purpose = "로그인 실패 임계값 초과 시 일정 시간 동안 계정 잠금을 실시하여 공격자의 자유로운 비밀번호 유추 공격을차단하기위함"
$threat = "로그인실패시일정시간동안계정잠금을하지않은경우, 공격자의 자동화된 비밀번호 추측 공격이 가능하여,사용자계정의비밀번호정보가유출될위험이존재함"
$criteria_good = "'계정잠금기간'및'계정잠금기간원래대로설정기간'이60분이상으로설정된경우"
$criteria_bad = "'계정 잠금기간' 및'잠금기간원래대로설정기간'이설정되지않거나60분미만으로설정된 경우"
$remediation = "'계정잠금기간'및'잠금기간원래대로설정기간'60분이상으로설정"
