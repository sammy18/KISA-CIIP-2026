...
$purpose = "적절한로깅설정으로유사시책임추적을위한로그를확보하기위함"
$threat = "감사 설정이 구성되어 있지 않거나 감사 설정 수준이 너무 낮은 경우 보안 관련 문제 발생 시 원인을 파악하기어려우며법적대응을위한충분한증거확보가어려운위험이존재함"
$criteria_good = "감사정책권고기준에따라감사설정이되어있는경우"
$criteria_bad = "감사정책권고기준에따라감사설정이되어있지않은경우"
$remediation = "이벤트에대한감사설정"
