...
$criteria_good = "아래 3가지 정책 모두 '사용'으로 되어 있는 경우`n1. 도메인 구성원: 보안 채널 데이터를 디지털 암호화 또는 서명(항상)`n2. 도메인 구성원: 보안 채널 데이터를 디지털 암호화(가능한 경우)`n3. 도메인 구성원: 보안 채널 데이터 디지털 서명(가능한 경우)"
$criteria_bad = "아래 3가지 정책 중 일부가 '사용 안 함'으로 되어 있는 경우"
