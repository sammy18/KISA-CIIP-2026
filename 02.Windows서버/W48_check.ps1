...
# 2. lib를 통한 결과 저장
$purpose = "시스템 로그온 화면의 종료 버튼을 비활성화함으로써 허가되지 않은 사용자를 통한 불법적인 시스템 종료를방지하고자함"
$threat = "로그온화면에'시스템종료'버튼이활성화되어있으면로그인을하지않고도불법적인시스템종료가 가능하여정상적인서비스운영에영향을줌"
$criteria_good = "'로그온하지않고시스템종료허용'이'사용안함'으로설정된경우"
$criteria_bad = "'로그온하지않고시스템종료허용'이'사용'으로설정된경우"
$remediation = "'시스템종료:로그온하지않고시스템종료'정책을'사용안함'설정"
