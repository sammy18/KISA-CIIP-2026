...
$purpose = "외부무단침입시설정될수있는불필요한예약작업의등록여부를확인하기위함"
$threat = "일정 시간마다 미리 설정해둔 프로그램을 실행할 수 있는 예약된 작업은 시작 프로그램과 더불어서 해킹과트로이목마,백도어를설치하여공격하기좋은경로로사용될위험이존재함"
$criteria_good = "불필요한명령어나파일등주기적인예약작업의존재여부를주기적으로점검하고제거한경우"
$criteria_bad = "불필요한명령어나파일등주기적인예약작업의존재여부를주기적으로점검하지않거나,불필 요한작업을제거하지않은경우"
$remediation = "예약작업에대한주기적인확인"
